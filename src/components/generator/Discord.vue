<template>
  <div class="discord">
    <v-tooltip text="Edit the text to create your own Discord-style logo" location="top" model-value>
    ...
    <div class="customize mt-3">
      <v-tooltip text="Customize your Discord-style logo" location="top" model-value>
        <template v-slot:activator="{ props }">
...
const backgroundColor = ref('#5865F2');
...
const twitter = () => {
  ...
  let text = encodeURIComponent(`Created my Discord-style logo with Porn-Logo.com! ${url}`);
  window.open(`https://twitter.com/intent/tweet?text=${text}`);
};

const transparentBgColor = computed(() => {
  return transparentBg.value ? 'transparent' : '#23272A';
});
</script>
