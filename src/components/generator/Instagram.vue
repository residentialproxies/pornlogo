<template>
  <div class="instagram">
    <v-tooltip text="Edit the text to create your own Instagram-style logo" location="top" model-value>
        ...
        <div v-bind="props" class="box">
          ...
          >
            <span
              @input="updateText"
              class="logo-text"
              :class="{ gradient: useGradient }"
              :style="useGradient ? {} : { color: textColor, 'background-color': backgroundColor }"
    ...
    <div class="customize mt-3">
      <v-tooltip text="Customize your Instagram-style logo" location="top" model-value>
        <template v-slot:activator="{ props }">
          <div v-bind="props" class="customize-color">
            <div class="flex items-center mb-3">
              <label class="flex items-center cursor-pointer">
                <v-checkbox-btn v-model="useGradient"></v-checkbox-btn>
                <span class="ml-2">Use Instagram Gradient</span>
              </label>
            </div>
            <div v-if="!useGradient">
              <div>
                Text Color:
...
const backgroundColor = ref('#E1306C');
...
const twitter = () => {
  ...
  let text = encodeURIComponent(`Created my Instagram-style logo with Porn-Logo.com! ${url}`);
