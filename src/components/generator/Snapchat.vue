<template>
  <div class="snapchat">
    <v-tooltip text="Edit the text to create your own Snapchat-style logo" location="top" model-value>
    ...
    <div class="customize mt-3">
      <v-tooltip text="Customize your Snapchat-style logo" location="top" model-value>
        <template v-slot:activator="{ props }">
...
const backgroundColor = ref('#FFFC00');
...
const twitter = () => {
  ...
  let text = encodeURIComponent(`Created my Snapchat-style logo with Porn-Logo.com! ${url}`);
