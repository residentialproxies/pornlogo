<template>
  <div class="spotify">
    <v-tooltip text="Edit the text to create your own Spotify-style logo" location="top" model-value>
    ...
    <div class="customize mt-3">
      <v-tooltip text="Customize your Spotify-style logo" location="top" model-value>
        <template v-slot:activator="{ props }">
...
const backgroundColor = ref('#1DB954');
...
const twitter = () => {
  ...
  let text = encodeURIComponent(`Created my Spotify-style logo with Porn-Logo.com! ${url}`);
