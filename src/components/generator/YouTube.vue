<template>
  <div class="youtube">
    <v-tooltip text="Edit the text to create your own YouTube-style logo" location="top" model-value>
    ...
    <div class="customize mt-3">
      <v-tooltip text="Customize your YouTube-style logo" location="top" model-value>
        <template v-slot:activator="{ props }">
...
const twitter = () => {
  ...
  let text = encodeURIComponent(`Created my YouTube-style logo with Porn-Logo.com! ${url}`);
